    ...
    showLoginScreen() {
        ...
        loginForm.innerHTML = `
            ...
            <div id="license-form" class="login-form">
                <p style="margin-bottom: 20px; color: #aaa;">Upload or Drag License File</p>
                ...
                ">
                    ...
                    <div style="color: #aaa;">Drop license file here or click to browse</div>
                ...
                <input type="text" id="license-username" placeholder="Username" style="
                    width: 100%;
                    padding: 15px;
                    margin-bottom: 15px;
                    border: none;
                    ...
                    box-sizing: border-box;
                ">
                <input type="password" id="license-password" placeholder="Password" style="
                    width: 100%;
                    padding: 15px;
                    margin-bottom: 20px;
                    border: none;
